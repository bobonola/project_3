...
<tr>
	<td style="width:700px;height:78px;padding:0;margin:0;vertical-align:top;">
		<p style="width:620px;margin:50px 0 40px 38px;text-align:center;font-size:0;line-height:0;"><img src="../images/email/img_txt_id01.jpg" alt="원두커피의 名家, JARDIN 문의하신 회원님 EMAIL을 발송해 드립니다." /></p>
	</td>
</tr>
<tr>
	<td style="width:700px;height:179px;padding:0;margin:0;vertical-align:top;">
		...
		<tr>
			<td style="width:618px;height:177px;padding:0;margin:0;vertical-align:top;font-size:0;line-height:0;background:#f9f9f9;">
				<p style="width:620px;margin:30px 0 0 0;padding:0;text-align:center;"><img src="../images/email/img_txt_id02.jpg" alt="쟈뎅샵에서 EMAIL찾기를 요청하셨습니다." /></p>
				<p style="width:620px;margin:30px 0 0 0;padding:0;text-align:center;color:#666666;font-size:12px;line-height:1;"><strong>EMAIL : <span style="color:#f7703c;line-height:1;">${session_email }</span></strong></p>
