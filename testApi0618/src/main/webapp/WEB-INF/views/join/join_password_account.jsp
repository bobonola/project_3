	...
	<div id="wrap">
		...
		<div id="container">
			<div id="content">
				...
				<div class="content_notice" id="notice_main">계좌 연결하기</div>
				<div class="content_notice" id="notice_sub">
					본인 인증을 위해 계좌 비밀번호를 <br>입력해주세요.
				</div>
							...
							<div class="id_area">
								<div class="input_row" id="id_area">
									<span class="input_box"> <input
										...
										name="user_id" id="user_id" class="int" placeholder=계좌비밀번호>
									</span>
								</div>
							</div>
							<a href="http://localhost:8000/join/join_success"
