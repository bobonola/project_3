...
CREATE TABLE RECORDS(
    ...
    MALL_CODE   VARCHAR2(255) NOT NULL,
    BANK_CODE   VARCHAR2(255) NOT NULL,
    MEANS       VARCHAR2(20) NOT NULL,
    PAYMENT_NUMBER  VARCHAR2(255) NOT NULL,
    RECORD_DATE TIMESTAMP DEFAULT SYSDATE,
...
COMMENT ON COLUMN RECORDS.MEANS IS '결제 수단';
COMMENT ON COLUMN RECORDS.PAYMENT_NUMBER IS '결제 수단의 번호';
...
CREATE TABLE PAYMENT_WAYS(
    ...
    CONSTRAINT PAYMENT_WAYS_UNIQUE UNIQUE(PAYMENT_NUMBER)
);
...
COMMENT ON COLUMN PAYMENT_WAYS.PAYMENT_NUMBER IS '결제 수단 번호';
...
ALTER TABLE PG.PAYMENT_WAYS
ADD CONSTRAINT PAYMENT_WAYS_UNIQUE UNIQUE (PAYMENT_NUMBER)
ENABLE;

--ALTER table payment_ways RENAME COLUMN cvs TO cvc;
--ALTER TABLE banks DROP COLUMN icon_path;
--ALTER TABLE PAYMENT_WAYS 
--drop COLUMN payment_password;
